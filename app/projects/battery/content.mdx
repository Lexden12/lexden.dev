...
I purchased some 16AWG XT30 battery connectors because the IP2368 board I am using has an XT30 connector on it for hooking up the battery. It also allows me to make the entire design more modular by using connectors rather than directly soldering.
